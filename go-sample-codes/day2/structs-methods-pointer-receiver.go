...
// Why not always use the pointer receiver, even if you're not going to change something?
// Well, you could just always use pointer receivers, but, value receivers are better for basic types and small structs.
// This is because they're much cheaper to work with and can reduce the amount of overall garbage created.
// That said, if the struct is very large, a pointer is more likely to be more efficient since we're not creating a copy.
